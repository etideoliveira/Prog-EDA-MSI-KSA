...
const char* date()
{
    ...
    time(&date); // Obtention de la date actuel en secondes (époque Unix)
...
const char* heure()
{
    ...
    time(&heure); // Obtention de l'heure acutel en secondes (époque Unix)
...
{
    // Déclaration du pointeur vers l'objet FILE
    FILE* fichier_log;
...
void log_binaire(int entree, int* resultat)
{
    ...
    // Déterminer la taille effective du tableau en fonction de la valeur binaire
    int taille = 0;
    ...
    resultat_binaire[taille] = '\0'; // Ajouter le terminateur de chaîne

    // Écrire les compteurs d'utilisation
    ecrire_log("compteur utilisation fonction binaire : %02d", NbrUtilisationBin); // Écrire le compteur de la fonction binaire
...
void log_trigonometrie(float entree1, float entree2, float adj, float opp, float hyp, float sin, float cos, float tan, float resultat)
{
    ...
    // Écrire les compteurs d'utilisation
    ecrire_log("compteur utilisation fonction trigonométrique : %02d\n", NbrUtilisationTri); // Écrire le compteur de la fonction trigonométrique
...
int Convert() {
    ...
    int entree = atoi(tbEntree);

    // enregistrement des log binaire
    log_binaire(entree, tbtest);
...
void Trigo (void)
{
        ...
        if (triangle.estDegre)
        {
            ...
            if ((choix1 == 1 && choix2 == 2) || (choix1 == 2 && choix2 == 1))
            {
                log_trigonometrie(triangle.adjacent, triangle.oppose, triangle.adjacent, triangle.oppose, triangle.hypotenuse, triangle.sinus, triangle.cosinus, triangle.tangente, triangle.angle.degre);
            }
            else if ((choix1 == 1 && choix2 == 3) || (choix1 == 3 && choix2 == 1))
            {
                log_trigonometrie(triangle.adjacent, triangle.hypotenuse, triangle.adjacent, triangle.oppose, triangle.hypotenuse, triangle.sinus, triangle.cosinus, triangle.tangente, triangle.angle.degre);
            }
            else if ((choix1 == 2 && choix2 == 3) || (choix1 == 3 && choix2 == 2))
            {
                log_trigonometrie(triangle.oppose, triangle.hypotenuse, triangle.adjacent, triangle.oppose, triangle.hypotenuse, triangle.sinus, triangle.cosinus, triangle.tangente, triangle.angle.degre);
            }
        }
        else
        {
            ...
            if ((choix1 == 1 && choix2 == 2) || (choix1 == 2 && choix2 == 1))
            {
                log_trigonometrie(triangle.adjacent, triangle.oppose, triangle.adjacent, triangle.oppose, triangle.hypotenuse, triangle.sinus, triangle.cosinus, triangle.tangente, triangle.angle.radians);
            }
            else if ((choix1 == 1 && choix2 == 3) || (choix1 == 3 && choix2 == 1))
            {
                log_trigonometrie(triangle.adjacent, triangle.hypotenuse, triangle.adjacent, triangle.oppose, triangle.hypotenuse, triangle.sinus, triangle.cosinus, triangle.tangente, triangle.angle.radians);
            }
            else if ((choix1 == 2 && choix2 == 3) || (choix1 == 3 && choix2 == 2))
            {
                log_trigonometrie(triangle.oppose, triangle.hypotenuse, triangle.adjacent, triangle.oppose, triangle.hypotenuse, triangle.sinus, triangle.cosinus, triangle.tangente, triangle.angle.radians);
            }
        }
        printf("Sinus : %.2f\n", triangle.sinus);
        printf("Cosinus : %.2f\n", triangle.cosinus);
